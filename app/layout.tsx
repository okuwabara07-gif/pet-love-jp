...
export const metadata: Metadata = {
  title: 'ペットラブ',
  description: 'ペット・動物の情報メディア',
  keywords: 'ペットラブ,ペット・動物の情報メディア',
  openGraph: {
    title: 'ペットラブ',
    description: 'ペット・動物の情報メディア',
    type: 'website',
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "ペットラブ", "description": "ペット・動物の情報メディア", "url": "https://pet-love-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社", "url": "https://colorpass-web.vercel.app"}, "potentialAction": {"@type": "SearchAction", "target": "https://pet-love-jp.vercel.app/blog/{search_term_string}", "query-input": "required name=search_term_string"}}`}} />
      </head>
      <body>{children}
